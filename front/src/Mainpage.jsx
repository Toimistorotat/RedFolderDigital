        ...
        <>
            ...
            <div className="flex justify-center mt-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-6">
                    ...
                    <div className="md:col-span-1 md:row-span-2 rounded-xl bg-white border-2 border-gray-300 p-6
shadow-[8px_8px_0px_rgba(0,0,0,0.25)]
hover:shadow-[10px_10px_0px_rgba(0,0,0,0.28)]
...
">
                    ...
                    <div className="md:col-span-2 rounded-xl bg-white border-2 border-gray-300 p-6
shadow-[8px_8px_0px_rgba(0,0,0,0.25)]
hover:shadow-[10px_10px_0px_rgba(0,0,0,0.28)]
hover:-translate-x-1.5 hover:-translate-y-0.5
hover:scale-[1.02]
...
">
                    ...
                    <div className="
md:col-span-2
rounded-xl bg-white border-2 border-gray-300 p-6
shadow-[8px_8px_0px_rgba(0,0,0,0.25)]
hover:shadow-[10px_10px_0px_rgba(0,0,0,0.28)]
hover:-translate-x-1.5 hover:-translate-y-0.5
hover:scale-[1.02]
